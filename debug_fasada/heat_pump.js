...
function hitTRVs(trvs) {
    try {
        ...
        MQTT.publish("bug/2", JSON.stringify(err), 1, true);
    }
}
...
function scheduledTask() {
    ...
    //     "shellytrv-8cf681c1abc8", "shellytrv-8cf681d9a230", "shellytrv-8cf681be1608"] //corridor, kitchen, directors, vicedirectors
