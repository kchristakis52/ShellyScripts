...
local topic = "shellies/shellyplusplugs-3ce90e2fbe5c/relay/0/power"
local client_id = "mqtt_lua_client"

-- Function to insert data into the sensor_data table
function insertData(timestamp, value)
    con:execute(string.format("INSERT INTO power_data (timestamp, value) VALUES (%d, %f)", timestamp, value))
end
    ...
    client:on{
        ...
        message = function(msg)
            ...
            if success then
                ...
                local sensorValue = tonumber(data.apower) or 0
